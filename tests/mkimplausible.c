 ...
 * that: tests/cli_test.sh at the `drydock-macho-rewrite segment` level and
 ...
 * change this repo made to drydock-macho-rewrite would have shipped with no coverage at all
