 ...
 * (change_dylib.c, cli/drydock-macho-rewrite.c, fix_macho.c, patch_macho.c, macho_grow.h --
 ...
 * /bin/sh wrappers around drydock-macho-rewrite (compat/<tool>.sh) when the compat tools
 ...
 * src/grow.h. Of that list only cli/drydock-macho-rewrite.c, src/ordinals.c and
...
#ifndef DRYDOCK_MACH_COMPAT_H
#define DRYDOCK_MACH_COMPAT_H
