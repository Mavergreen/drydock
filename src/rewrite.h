#ifndef DRYDOCK_REWRITE_H
#define DRYDOCK_REWRITE_H
/* mr_ -- rewriting a Mach-O's dylib load commands and LC_RPATHs. Both
 * front-ends shared this code: cli/drydock-macho-rewrite.c's dylib/rpath/lc/segment verbs
 ...
 * spec: tests/cli_test.sh's "drydock-macho-rewrite stands alone" -- the CLI links this in
 ...
 * spec: cli/drydock-macho-rewrite.c's EX_REFUSED -- why a refusal is the LOWER code, and
